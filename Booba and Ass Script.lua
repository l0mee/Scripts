-- omg they jiggle woow
-- USE AUTORIG HATS IN  https://www.roblox.com/games/95964727828755/autorig AND CHANGE YOUR RIG STUFF IN LINE 981 TO 985
-- HATS:
-- https://www.roblox.com/catalog/13928911963/Big-Matte-White-Sphere
-- https://www.roblox.com/catalog/83775390730955/Shiny-Sphere
-- https://www.roblox.com/catalog/6685282255/Stickman-Head
-- https://www.roblox.com/catalog/13760253770/Big-Matte-Black-Sphere
...
wait(0.1)
local e = workspace.DuskySpoon["Blue Spherekin"].Handle.AccessoryWeld
local asdf = workspace.DuskySpoon.BlueRoundNoobHead.Handle.AccessoryWeld

e.C0 = CFrame.new(-0.6,1.5,1)
asdf.C0 = CFrame.new(0.7, 1.5, 1)
local Player = game:GetService("Players").LocalPlayer
local user = player.Name
local Character = workspace:WaitForChild(user)

local S = {
	fattiddie = Character:WaitForChild("SpherkinAccessory"),
	fatiddie = Character:WaitForChild("StickmanHead"),

	fattiddie2 = Character:WaitForChild("Blue Spherekin"),
	fatiddie2 = Character:WaitForChild("BlueRoundNoobHead")
}
...
local Jiggle_RB = Instance.new("Attachment", Torso)
Jiggle_RB.Name = "Jiggle_RB"
Jiggle_RB.Position = Vector3.new(-0.6, 0.5, -1)

local Jiggle_LB = Instance.new("Attachment", Torso)
Jiggle_LB.Name = "Jiggle_LB"
Jiggle_LB.Position = Vector3.new(0.6, 0.5, -1)

local Jig1_RB, Jig2_RB = setupHandle(S.fattiddie2.Handle)
local Jig1_LB, Jig2_LB = setupHandle(S.fatiddie2.Handle)

local Spring_RB = Instance.new("SpringConstraint", Torso)
Spring_RB.Name = "Spring_RB"
Spring_RB.Damping = 100
Spring_RB.FreeLength = 0.1
Spring_RB.Stiffness = 3000
Spring_RB.Attachment0 = Jiggle_RB
Spring_RB.Attachment1 = Jig1_RB

local Spring_LB = Instance.new("SpringConstraint", Torso)
Spring_LB.Name = "Spring_LB"
Spring_LB.Damping = 100
Spring_LB.FreeLength = 0.1
Spring_LB.Stiffness = 3000
Spring_LB.Attachment0 = Jiggle_LB
Spring_LB.Attachment1 = Jig1_LB

local Spring_3 = Instance.new("SpringConstraint", Torso)
Spring_3.Name = "Spring_3"
Spring_3.Damping = 2.5
Spring_3.FreeLength = 1.5
Spring_3.Stiffness = 40
Spring_3.Attachment0 = Jiggle_M
Spring_3.Attachment1 = Jig2_RB

local Spring_4 = Instance.new("SpringConstraint", Torso)
Spring_4.Name = "Spring_4"
Spring_4.Damping = 2.5
Spring_4.FreeLength = 1.5
Spring_4.Stiffness = 40
Spring_4.Attachment0 = Jiggle_M
Spring_4.Attachment1 = Jig2_LB
